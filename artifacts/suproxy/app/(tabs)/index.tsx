...
const styles = StyleSheet.create({
  ...
  remainingDaysText: { fontSize: 14, fontWeight: "600", color: "#24A1DE" },
  ...
  connectLetter: { fontSize: 56, fontWeight: "700", letterSpacing: 0.8, zIndex: 1 },
  statusContainer: { alignItems: "center", gap: 4 },
  statusText: { fontSize: 18, fontWeight: "600" },
  timerText: { fontSize: 14, fontWeight: "600", color: "#24A1DE" },
  addKeyButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    backgroundColor: "#24A1DE", borderRadius: 16, paddingVertical: 16,
  },
  addKeyButtonText: { color: "#FFFFFF", fontWeight: "600", fontSize: 21, letterSpacing: 0.8 },
  buyKeyButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    backgroundColor: "#F5F5F5", borderRadius: 16, paddingVertical: 16,
    borderWidth: 2, borderColor: "#24A1DE",
  },
  buyKeyButtonText: { color: "#24A1DE", fontWeight: "600", fontSize: 21, letterSpacing: 0.8 },
  ...
  serversTitle: { fontSize: 20, fontWeight: "600", letterSpacing: 0.8, color: "#24A1DE", flex: 1 },
  serversChevron: { fontSize: 14, fontWeight: "600", color: "#24A1DE" },
  ...
  serverMs: { fontSize: 11, fontWeight: "600" },
  modalOverlay: {
  ...
  modalTitle: { fontSize: 20, fontWeight: "600", color: "#333333" },
  modalSubtitle: { fontSize: 14, fontWeight: "600", color: "#999999", lineHeight: 20, marginBottom: 4 },
  textInput: {
  ...
  cancelButtonText: { fontSize: 16, fontWeight: "600", color: "#999999" },
  saveButton: {
  ...
  tariffInfo: { gap: 2 },
  tariffName: { fontSize: 16, fontWeight: "600", color: "#333333" },
  tariffDays: { fontSize: 13, fontWeight: "600", color: "#999999" },
  tariffBadge: {
    backgroundColor: "#F0F9FF", borderRadius: 8,
    paddingHorizontal: 10, paddingVertical: 4,
  },
  tariffBadgeText: { fontSize: 12, fontWeight: "600", color: "#24A1DE" },
  tariffBadgePrimary: {
    backgroundColor: "rgba(255,255,255,0.25)", borderRadius: 8,
    paddingHorizontal: 10, paddingVertical: 4,
  },
  tariffBadgePrimaryText: { fontSize: 12, fontWeight: "600", color: "#FFFFFF" },
});
